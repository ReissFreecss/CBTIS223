...
namespace CBTIS223_v2.Controllers
{
    public class PDFController : Controller
    {
        ...
        {
            string tipo = Request.Form["Selector"];
            if (tipo == "1")
            {
                ...
                try
                {
                            ...
                            formato_CP_SS.Page(page =>
                            {
                                ...
                                page.Content().Column(col1 =>
                                {
                                    ...
                                    col1.Item().DefaultTextStyle(textoArial).Padding(10).Text(txt =>
                                    {
                                        ...
                                        txt.Span(", cubriendo un horario de:").LetterSpacing(0.05f);
                                    });
                    ...
                    return File(stream, "application/pdf", "Hoja Presentacion " + idEstudiante +".pdf");
                }
                catch (Exception ex)
                {
